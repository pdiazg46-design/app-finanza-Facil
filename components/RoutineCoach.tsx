...
export function RoutineCoach({ isOpen, onClose }: RoutineCoachProps) {
    ...
    const steps: Step[] = [
        {
            title: t('routine.tutorial.masterGoal.title'),
            description: t('routine.tutorial.masterGoal.description'),
            icon: Target,
        ...
        {
            title: t('routine.tutorial.burnRate.title'),
            description: t('routine.tutorial.burnRate.description'),
            icon: Flame,
        ...
        {
            title: t('routine.tutorial.realStructure.title'),
            description: t('routine.tutorial.realStructure.description'),
            icon: Database,
        ...
        {
            title: t('routine.tutorial.magicVoice.title'),
            description: t('routine.tutorial.magicVoice.description'),
            icon: Mic,
        ...
        {
            title: t('routine.tutorial.freedomDays.title'),
            description: t('routine.tutorial.freedomDays.description'),
            icon: Sun,
                ...
                {!isExiting && (
                    ...
                    >
                        ...
                        <div className="px-8 pb-8 pt-2 flex flex-col gap-3">
                            ...
                            >
                                {currentStep === steps.length - 1 ? t('routine.tutorial.readyToWin') : t('routine.tutorial.nextStep')}
                            </button>
                            ...
                            <div className="flex justify-between items-center px-2">
                                ...
                                >
                                    <ChevronLeft className="w-3 h-3" /> {t('routine.tutorial.back')}
                                </button>
                                ...
                                >
                                    {t('routine.tutorial.skipTutorial')}
                                </button>
                            </div>
                        </div>
                    </motion.div>
