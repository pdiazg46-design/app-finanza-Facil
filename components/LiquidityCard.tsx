                ...
                <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-1.5">
                            ...
                            <p className="text-sm font-black text-slate-900 uppercase tracking-tighter">{title}</p>
                        </div>
                        <InfoTooltip title={title} content={infoContent} description={infoDescription} />
                    </div>
                    <p className="text-xs text-slate-700 mb-2 font-black uppercase tracking-tight">{subtitle}</p>
                    <p className="text-2xl font-black text-slate-900 tracking-tight font-[family-name:var(--font-montserrat)]">
                    ...
                    <div className="flex flex-col gap-1 pt-2 border-t border-slate-50">
                        <div className="flex items-center text-red-600 text-xs font-black uppercase tracking-tighter">
                            <TrendingDown className="w-4 h-4 mr-1.5" />
                            <span>{t('dimension.accountsPayable')}</span>
                        </div>
                        <div className="text-base font-black text-slate-900 pl-5">
    ...
    return (
        <Card className="shadow-lg border-0 bg-slate-50 rounded-3xl group cursor-pointer hover:bg-white hover:shadow-xl transition-all border border-slate-100/50 relative overflow-hidden">
            ...
            <CardContent className="p-4 flex flex-col items-center text-center justify-center min-h-[160px]">
                ...
                <p className="text-xs text-slate-700 mb-3 font-black uppercase tracking-tight">{subtitle}</p>
                <div className="text-2xl font-black text-slate-800 tracking-tight font-[family-name:var(--font-montserrat)]">
                    <CurrencyText value={amount} />
                </div>
            </CardContent>
        </Card>
